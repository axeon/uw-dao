...
public class DMConfig {
    ...
    /**
     * @param connRoute the connRoute to set
     */
    ...
    /**
     * @param tableSharding the tableSharding to set
     */
    ...
    public static class ConnPoolConfig {
        ...
        /**
         * @param connIdleTimeout the connIdleTimeout to set
         */
        ...
        /**
         * @param connBusyTimeout the connBusyTimeout to set
         */
        ...
        /**
         * @param connMaxAge the connMaxAge to set
         */
    ...
    public static class TableShardingConfig {
        ...
        /**
         * @param autoGen the autoGen to set
         */
    ...
    public static class SqlStatsConfig {
        ...
        /**
         * @param dataKeepDays the dataKeepDays to set
         */
