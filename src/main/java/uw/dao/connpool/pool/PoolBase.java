...
import uw.dao.connpool.util.DriverDataSource;
import uw.dao.connpool.util.PropertyElf;
...
import static uw.dao.connpool.pool.ProxyConnection.*;
import static uw.dao.connpool.util.ClockSource.*;
import static uw.dao.connpool.util.UtilityElf.createInstance;
